...
class ProgramEnv1_new_vae_v2(ProgramEnv_new_vae_v2):
    """MDP2
        state: None
    ...
    def __init__(self, config, task=None, metadata={}):
        super(ProgramEnv1_new_vae_v2, self).__init__(config, task, metadata)
